...
client = pymongo.MongoClient("mongodb+srv://brsathiya:thaaranikA2015@cluster0.ryric7j.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
db = client.sample_airbnb
details = db.listingsAndReviews

filepath = "C:\\Users\\karth\\Downloads\\Airbnb-main\\Airbnb-main\\Airbnb.csv"
...
if select == "Home":
    ...
    st.markdown("Visualization by :blue[B_R_Sathiya]")
